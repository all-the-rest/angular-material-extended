...
@Component({
  ...
  template: `
    <section id="ripples-basic" class="rui-mb-8">
      ...
      <div class="rui-rounded-lg rui-border rui-border-outline-variant rui-bg-surface demo-controls rui-p-5 rui-flex rui-flex-col rui-sm:flex-row rui-flex-wrap rui-gap-4 rui-items-center">
        <div
          matRipple
